...
### ➜ [Lire le dernier changelog / résumé de validation](docs/procedure/99_changelog_validation_part_21.md)
...
> Le changelog précédent reste disponible ici : [Changelog / validation — partie 20](docs/procedure/99_changelog_validation_part_20.md).  
...
* [Changelog / validation — partie 21](docs/procedure/99_changelog_validation_part_21.md)
* [Module 05 — Visual base meshes & textures — partie 2](docs/procedure/05_visual_base_meshes_textures_part_2.md)
* [Module 05 — Visual base meshes & textures — partie 3](docs/procedure/05_visual_base_meshes_textures_part_3.md)
* [Module 05.1 — Lighting effects & particles — partie 1](docs/procedure/05_1_lighting_effects_particles_part_1.md)
...
Ces snapshots plus anciens sont conservés comme jalons historiques. Le snapshot courant de comparaison anti-doublon est désormais celui de l’**étape 600**.
...
* **Dernière étape documentée :** Étape 600 — Banner fix + MIF + Separated Slash Effects X
* **Prochaine étape attendue :** Étape 601 — suite prudente selon l’état GitHub post-600
* **Blocs récemment enrichis :** `05 - VISUAL BASE MESHES TEXTURES`, `05.1 - LIGHTING EFFECTS & PARTICLES`, décisions différées complémentaires
* **Snapshot MO2 courant :** [panneau gauche étape 600](docs/configuration/SKYFORGE_Load_Order_MO2_panneau_gauche_etape_600.md)
...
L’état exact le plus récent est toujours consigné dans le [résumé de l’état actuel](docs/procedure/00_resume_etat_actuel.md), le [dernier changelog](docs/procedure/99_changelog_validation_part_21.md) et les fichiers thématiques du module en cours.

---

## Règles de lecture importantes

* Le snapshot **étape 600** est la référence courante pour vérifier si un mod est déjà installé.
* Les snapshots **578**, **567**, **553**, **530**, **509**, **480** et **450** restent des jalons historiques.
