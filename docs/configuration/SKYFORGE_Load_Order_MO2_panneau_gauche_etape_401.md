# SKYFORGE - Load Order MO2 - Panneau gauche - Étape 401

## Statut du snapshot

- Type : snapshot du panneau gauche de Mod Organizer 2.
- Dernière étape couverte : Étape 401 — ajout CBPC pour 3BA.
- Séparateur actuellement ouvert : 09 - ANIMATIONS SKELETON PHYSICS.
- Module parent lié : 08 - BODY RACE NPC APPEARANCE.
- Compteur ESP + ESM non-light au moment du snapshot : 102.
- LOOT : non lancé.
...
Ce fichier conserve l'ordre des mods dans le panneau gauche de MO2 au moment du snapshot.

Le copier/coller du panneau gauche ne permet pas de garantir automatiquement l'état coché / décoché de chaque mod.

Convention de lecture :

- Les annotations déjà présentes dans les noms de mods sont conservées telles quelles : `A REINSTALL PLUS TARD`, `PATCHES A VOIR PLUS TARD`, `DECOCHE`, `RESERVE`, `PROVISOIRE`, etc.
- En absence d'annotation explicite, le statut exact coché / décoché doit être vérifié dans MO2.
- Ce fichier n'est pas un load order plugin. Il ne remplace pas le panneau droit de MO2.
- L'ordre plugin sera traité plus tard, après lancement de LOOT et stabilisation des blocs concernés.

## Snapshot panneau gauche MO2
...
Crash Logger SSE AE VR - PDB support 1.5.97
...
Object Categorization Framework - A REINSTALL PLUS TARD
...
KiLoader for Skyrim
KiLoader - Generated Empty Folders
...
Keyword Patch Collection - A RESINTALL PLUS TARD
SSE Engine Fixes
...
NPC AI Process Position Fix - NG - A REINSTALL PLUS TARD
Animation Queue Fix
...
bc036's Tweaks
bc036's Tweaks - FR
Andrealletius' Exploit Fixes — options FOMOD à revoir plus tard
...
Atlas Map Markers - Updated with MCM - FR
...
Majestic Mountains Main - A REINSTALL PLUS TARD
...
Lux Orbis (patch hub) - A REINSTALL PLUS TARD
Lux
...
Rob's Bug Fixes - TGC Kynesgrove - A REINSTALL PLUS TARD
...
Rob's Bug Fixes - TGC Rorikstead - A REINSTALL PLUS TARD
...
Lakeview Manor - As It Should Be - (CC) Fishing Compatiblity Patch
[07.2 - FARMHOUSES]
...
My Road Signs are Beautiful - French - A REINSTALL PLUS TARD
WiZkiD Signs - A REINSTALL PLUS TARD
...
The JK's Interiors of EEK's Whiterun - A REINSTALL PLUS TARD
JK's White Phial
...
JK's Temple of Dibella - PATCHES A VOIR PLUS TARD - vérifier SexLab Dibella Sisterhood
...
College Of Winterhold Brazier Overhaul Yea - PATCHES A VOIR PLUS TARD
...
[0.8.2 - HAIR-EYES-BROWS-OVERLAYS]
...
Kalilies Brows
Just Blood - Dirt and Blood Lite - PROVISOIRE - sang léger uniquement - choix hygiène Bathing vs Dirt&Blood à reprendre plus tard
...
Community Overlays 2 - Main - CBBE and Male - CHOIX PROVISOIRE CBBE+MALE - COHERENT 3BAHIMBO - A REVOIR SI BODY FINAL CHANGE
...
CBBE 3BA (3BBB) - A REINSTALL PLUS TARD - options SOScollisions
The New Gentleman - PATCHES A VOIR PLUS TARD
The New Gentleman - Generated INI
PB's Silky Skin - SKIN PJ UNIQUEMENT A TERME - actuellement écrasée par BnP - isoler plus tard
