# SKYFORGE — Load Order MO2 panneau gauche — Étape 685

Snapshot manuel du panneau gauche MO2 après l’étape **685 — Clôture provisoire SexLab Core 13-A**.
...
Ce fichier doit recevoir le collage complet du **panneau gauche MO2** après l’étape 685.

Il sert de référence anti-doublon et de comparaison structurelle pour la suite du modpack.
...
SSE Display Tweaks
SSE Display Tweaks SKYGORGE INI
...
PhotoMode
SKYFORGE - Photo Mode MCM Settings
PhotoMode - FR
...
SLSF Reloaded 3.4.1 - DECOCHE - A ACTIVER APRES INSTALLATION MCM SEXLAB
