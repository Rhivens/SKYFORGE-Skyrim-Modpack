...
- Snapshot MO2 panneau gauche courant : **à fournir après mise à jour GitHub post-578**
- Le snapshot 567 reste un jalon historique post-567.
...
3. `docs/procedure/99_changelog_validation_part_20.md`
4. `docs/procedure/05_visual_base_meshes_textures_part_2.md`
5. `docs/procedure/06_decisions_differees_part_6.md`
6. `docs/procedure/99_changelog_validation_part_19.md`
7. `docs/procedure/05_visual_base_meshes_textures_part_1.md`
8. `docs/procedure/11_1_followers_npcs_dialogues_part_4.md`
9. `docs/procedure/03_ui_hud_menus_part_1.md`
10. `docs/procedure/04_audio_music_voices_part_2.md`
11. `docs/procedure/06_landscape_grass_trees_water_part_1.md`
12. `docs/procedure/06_decisions_differees_part_4.md`
13. `docs/procedure/06_decisions_differees_part_5.md`
14. `docs/configuration/SKYFORGE_Load_Order_MO2_panneau_gauche_etape_567.md` — jalon historique post-567
15. `docs/configuration/SKYFORGE_Load_Order_MO2_panneau_gauche_etape_553.md` — jalon historique post-553
16. `docs/configuration/SKYFORGE_Load_Order_MO2_panneau_gauche_etape_530.md` — jalon historique post-530
17. `docs/procedure/99_changelog_validation_part_17.md`
18. `docs/procedure/11_1_followers_npcs_dialogues_part_3.md`
19. `docs/procedure/11_2_custom_followers_companions_part_2.md`
20. `docs/procedure/11_2_custom_followers_companions_part_1.md`
21. `docs/procedure/11_1_followers_npcs_dialogues_part_2.md`
22. `docs/procedure/11_1_followers_npcs_dialogues_part_1.md`
23. `docs/configuration/09_regle_vampire_skyforge.md`
24. `docs/configuration/08_body_skins_bodyslide_vigilances.md`
25. `docs/configuration/SKYFORGE_Load_Order_MO2_panneau_gauche_etape_509.md` — jalon historique post-509
26. `docs/configuration/SKYFORGE_Load_Order_MO2_panneau_gauche_etape_480.md` — jalon historique post-480
27. `docs/configuration/SKYFORGE_Load_Order_MO2_panneau_gauche_etape_450.md` — jalon historique post-450
